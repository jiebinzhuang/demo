...
<CENTER>
<STRONG style="FONT-SIZE: 40pt">JSP探针</STRONG>
  选项：<a href="#ServerInfo">服务器相关</a> | <a href="#JAVAInfo">JAVA相关</a> | <a href="#Paramter">参数查询</a>  | <a href="#ServerAbility">服务器运算能力</a> | <a href="#ISpeedTest">网络速度</a> | <a href="./snoop" target="_blank">Snoop</a> | <a href="javascript:location.reload()">刷新</a><a name="ServerInfo"></a>
  ...
  <table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
    ...
    <tr> 
      <td style="display" id='submenu2'> 
	  	<table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#f58200">
          <tr bgcolor="#fcc79b" height="22"> 
            <td>&nbsp;请查询系统的参数信息(<a href="javascript:void(0)" onClick="document.queryform.submit()">枚举所有参数信息</a>)</td>
          </tr>
          <tr bgcolor="#FFFFFF" height="22"> 
            <td align=center>
...
%>
<div>页面执行时间：约<%=timePageUse%>毫秒</div>
</CENTER>
</body>
</html>