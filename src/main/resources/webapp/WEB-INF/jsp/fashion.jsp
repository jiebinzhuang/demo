...
<div class="box" id="box">
    <div class="tab" id="tab">
        ...
        <span class="current" style="width: 100px"><a href="index?type=fashion" title="Instagram Posts">Fashion</a></span>
    ...
    <div class="bd">
        ...
        <li class="show">
            <%
                java.util.List<org.bson.Document> fashionlist=(java.util.List<org.bson.Document>)request.getAttribute("list");
